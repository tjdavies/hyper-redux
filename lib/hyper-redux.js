...
export function makeContextConsumer() {
...
var Wrapper = /** @class */ (function (_super) {
    ...
    Wrapper.prototype.render = function () {
        return (React.createElement(appContext.Provider, { value: { state: this.state.value, actions: this.props.actions } }, this.props.view(this.state.value, this.props.actions)));
    };
    return Wrapper;
}(React.Component));
